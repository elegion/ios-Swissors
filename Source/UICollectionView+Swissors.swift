...
public extension UICollectionView {
    ...
    func sw_registerReusableCell<T: UICollectionViewCell>(ofType cellType: T.Type) {
        register(cellType, forCellWithReuseIdentifier: String(describing: cellType))
    }
    
    @available(*, deprecated, message: "Use sw_register<Cell: UICollectionViewCell>(cellType: Cell.Type, bundle: Bundle, tryNib: Bool) instead")
    func sw_registerReusableCellNib<T: UICollectionViewCell>(ofType cellType: T.Type, bundle: Bundle? = .main) {
    ...
    func sw_dequeueReusableCell<T: UICollectionViewCell>(ofType cellType: T.Type, for indexPath: IndexPath) -> T {
    ...
    func sw_registerReusableSupplementaryView<T: UICollectionReusableView>(ofType type: T.Type, kind: String) {
        register(type, forSupplementaryViewOfKind: kind, withReuseIdentifier: String(describing: type))
    }
    
    @available(*, deprecated, message: "Use sw_register<SupplementaryView: UICollectionReusableView>(supplementaryViewType: SupplementaryView.Type, kind: String, bundle: Bundle, tryNib: Bool) instead")
    func sw_registerReusableSupplementaryViewNib<T: UICollectionReusableView>(ofType type: T.Type, kind: String, bundle: Bundle? = .main) {
    ...
    func sw_dequeueReusableSupplementaryView<T: UICollectionReusableView>(ofType type: T.Type, kind: String, for indexPath: IndexPath) -> T {
